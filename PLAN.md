...
|---|---|---|---|---|
| 001 | Vendor v2 spec + drift CI | `spec/`, `scripts/`, `.github/workflows/spec-drift.yml` | — | 1 |
| 002 | Search params (kl tables, tbs mappers) | `src/search/params.ts` + test | — | 1 |
| 003 | SearXNG provider | `src/search/types.ts`, `src/search/searxng.ts`, `Env` + tests | 002 (contract) | 1 |
